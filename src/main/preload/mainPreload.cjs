...
const api = {
  ...
  applyNetworkAccess: (lanEnabled, advertisedAddress) => ipcRenderer.invoke('settings:apply-network-access', { lanEnabled, advertisedAddress }),
  ...
  executePrompt: (prompt, mode, provider, model, cliRequest) => ipcRenderer.invoke('execute-prompt', { prompt, mode, provider, model, cliRequest }),
